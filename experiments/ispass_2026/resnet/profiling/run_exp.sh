...
echo "Running resnet 4GPU experiments"
...
do
    ...
    do
        ...
        mkdir -p "${RUN_DIR}"
        CHAKRA_OUTPUT_DIR="${WORKLOAD_DIR}"
...
echo "Waiting for any background tasks"
wait
